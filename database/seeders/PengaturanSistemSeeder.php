...
class PengaturanSistemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                'kategori' => 'integration',
                'kunci' => 'integration.mobile_jkn.enabled',
                'nilai' => '0',
                'tipe_data' => 'boolean',
                'deskripsi' => 'Aktifkan integrasi Mobile JKN BPJS',
                'is_sensitif' => false,
            ],
            [
                'kategori' => 'integration',
                'kunci' => 'integration.mobile_jkn.kdppk',
                'nilai' => null,
                'tipe_data' => 'string',
                'deskripsi' => 'Kode PPK (Provider) untuk Mobile JKN',
                'is_sensitif' => false,
            ],
            [
                'kategori' => 'integration',
                'kunci' => 'integration.mobile_jkn.cons_id',
                'nilai' => null,
                'tipe_data' => 'encrypted',
                'deskripsi' => 'Consumer ID untuk Mobile JKN API',
                'is_sensitif' => true,
            ],
            [
                'kategori' => 'integration',
                'kunci' => 'integration.mobile_jkn.secret_key',
                'nilai' => null,
                'tipe_data' => 'encrypted',
                'deskripsi' => 'Secret Key untuk Mobile JKN API',
                'is_sensitif' => true,
            ],
            [
                'kategori' => 'integration',
                'kunci' => 'integration.mobile_jkn.auto_sync_interval',
                'nilai' => '15',
                'tipe_data' => 'integer',
                'deskripsi' => 'Interval auto-sync dalam menit (0 = disabled)',
                'is_sensitif' => false,
            ],
            [
                'kategori' => 'integration',
                'kunci' => 'integration.mobile_jkn.sync_days_ahead',
                'nilai' => '3',
                'tipe_data' => 'integer',
                'deskripsi' => 'Jumlah hari ke depan untuk sync (1-7 hari)',
                'is_sensitif' => false,
            ],
            [
                'kategori' => 'integration',
