...
export default function SerahTerimaObatPage() {
  ...
  const createHandoverMutation = useMutation({
    ...
    onSuccess: async (data) => {
      toast.success('Serah terima obat berhasil dibuat')
    ...
    onError: (error: any) => {
      ...
      toast.error('Gagal membuat serah terima obat')
    }
  })
  ...
  // Flatten data
  const prescriptions = prescriptionsData?.pages.flatMap(page => page.data?.data || []) || []
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="🔄 Serah Terima Obat"
        description="Kelola proses serah terima obat kepada pasien dengan edukasi dan dokumentasi lengkap"
      />
      ...
      {handovers.length > 0 && (
        <Card className="p-6">
          <h3 className="text-lg font-semibold mb-4">Riwayat Serah Terima Hari Ini</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-semibold">Form Serah Terima Obat</h3>
              <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Serah Terima Berhasil!</h3>
              <p className="text-gray-600 mb-6">
                Receipt serah terima obat telah dibuat untuk {selectedHandover.prescription.patient.nama_pasien}
              </p>
