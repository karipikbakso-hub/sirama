    ...
    <>
      <div className="flex min-h-screen bg-background text-foreground">
        ...
        <aside className="hidden md:flex flex-col w-64 h-screen bg-card border-r border-border px-6 py-8 space-y-6 text-sm">
          <Link href="/dashboard/dokter" className="text-center text-4xl font-bold tracking-wide select-none">
            SIRAMA
          </Link>

          <div>
            <div className="px-3 py-2 text-xs uppercase tracking-wider text-muted-foreground">Modul Dokter</div>
